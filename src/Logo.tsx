export default function Logo({ className }: { className?: string }) {
  return (
    <svg
      ...
      width="100"
      height="51"
      viewBox="0 0 244.1 124.3"
      xmlns="http://www.w3.org/2000/svg"
      role="img"
      aria-label="Turkish Aerospace"
    >
      {/* Symbol – blue arrow */}
      <polyline
